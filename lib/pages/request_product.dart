...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  final categories = ['Body Care','Dental Care','Hair Care','Makeup','Skincare'];
  TextEditingController productNameController = TextEditingController(); // emailController.text kullanarak girilen maili alabilirsin
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Align(alignment:Alignment.center,child: Text("New Product Form")),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Image.asset('assets/hair-care.png',
                    width: 100,
                    height: 100,),
                    Image.asset('assets/make-up.png',
                      width: 100,
                      height: 100,),
                    Image.asset('assets/skin-care.png',
                      width: 100,
                      height: 100,),
                  ],
                ),
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Align(alignment: Alignment.center,child: Text("Category",)),
                      isExpanded:true,
                      value:value,
                      iconSize: 36,
